...
### Section 2: processing the data into 3 tables (buffers: 25, 50, and 100 ft) and change the data format
    ...
    intro[1, ] <- "This spreadsheet contains information about the water-in-cellar complaints recorded in the cityworks database during various stages of SMPs constructions. The information contains:"
...
### Section 3: write  the data into  three sheets within an xlsx file 
    ...
    write.xlsx(intro, file = "wic_complaints.xlsx", sheetName = "Introduction", append = TRUE, col.names = FALSE, row.names = FALSE)
    
    write.xlsx(output_25ft, file = "wic_complaints.xlsx", sheetName = "25_ft_radius", append = TRUE )
    
    write.xlsx(output_50ft, file = "wic_complaints.xlsx", sheetName = "50_ft_radius", append = TRUE )
    
    write.xlsx(output_100ft, file = "wic_complaints.xlsx", sheetName = "100_ft_radius", append = TRUE )
