...
```{r section 10- WIC parcels map data update, include = FALSE, eval= nrow(fieldwork.wic_smps)>0 & nrow(new_smp_spatial)>0}
...
```{r section 11- all parcels (wic and non-wic) map data update, include = FALSE, eval= nrow(fieldwork.wic_smps)>0 & nrow(new_smp_spatial)>0}
