...
```{r setup, include=FALSE}
  ...
  wic_parcels <- data.frame(matrix(NA, 0, 2))
...
The new and modified work orders were searched in GIS database by their facility id, location, and XY coordinate. This has resulted in `r nrow(wic_parcels)` parcel attachment.  
