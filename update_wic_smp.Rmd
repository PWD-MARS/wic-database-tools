...
```{r Section 6- write to DB ,include=FALSE}
...
```{r Section 8- SMP intersect, include=FALSE, eval= nrow(wic_parcels) > 0 }
...
```
 ...
 `r       kable(smp_milestones, caption = "New WIC_SMP association at 25, 50, and 100 ft buffer distance")`
