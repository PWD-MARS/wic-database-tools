...
```
Public SMPs were intersected with WIC-associated parcels within 25, 50, and 100 ft of distance from them. This resulted in `r nrow(output_25)`, `r nrow(output_50)`, and `r nrow(output_100)` SMP_WIC attachment, respectively. 


```{r displaying summary table of SMP association, include=FALSE}
