...
```{r displaying summary table of SMP association, include=FALSE, eval= nrow(output_25)>0}
...
```{r displaying summary table of SMP association, include=FALSE, eval= nrow(output_50)>0}
...
```{r displaying summary table of SMP association, include=FALSE, eval= nrow(output_100)>0}
