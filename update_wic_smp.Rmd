...
```{r section 8- displaying summary table of SMP association at buffer 25ft, include=FALSE, eval= nrow(output_25)>0}
...
```{r  section 9- displaying summary table of SMP association at buffer 50ft, include=FALSE, eval= nrow(output_50)>0}
...
```{r section 10- displaying summary table of SMP association at buffer 100ft, include=FALSE, eval= nrow(output_100)>0}
...
```{r section 11- DB disconnect, include=FALSE}
