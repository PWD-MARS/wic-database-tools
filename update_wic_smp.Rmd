...
```
Public SMPs were intersected with parcels associated with new/changed WIC parcels within 25, 50, and 100 ft of distance from them. This resulted in `r nrow(output_25)`, `r nrow(output_50)`, and `r nrow(output_100)` SMP_WIC attachment, respectively. 
