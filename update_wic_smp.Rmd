...
```{r Section 6- write to DB ,include=FALSE, eval = !is.null(wic_parcel_attach)}
...
```{r section 10-  showing the table in kable, include = FALSE, eval= nrow(smp_milestones)>0}
