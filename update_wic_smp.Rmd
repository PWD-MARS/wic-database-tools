...
```{r section 7- displaying summary table of SMP association at buffer 25ft, include=FALSE, eval= nrow(output_25)>0}
      ...
      output_25['construction_phase'] <- replace(output_25$phase_lookup_uid, output_25$phase_lookup_uid == 2, "During-construction" )
      output_25['construction_phase'] <- replace(output_25$phase_lookup_uid, output_25$phase_lookup_uid == 3, "Post-construction" )
      output_25['construction_phase'] <- replace(output_25$phase_lookup_uid, output_25$phase_lookup_uid == 4, "Unknown" )
      output_25 <- output_25 %>% select(smp_id, construction_phase)
      
      kable(output_25, caption = "SMPs within 25 ft of new/changed WIC parcels ")
...
```{r  section 8- displaying summary table of SMP association at buffer 50ft, include=FALSE, eval= nrow(output_50)>0}
      ...
      output_50['construction_phase'] <- replace(output_50$phase_lookup_uid, output_50$phase_lookup_uid == 2, "During-construction" )
      output_50['construction_phase'] <- replace(output_50$phase_lookup_uid, output_50$phase_lookup_uid == 3, "Post-construction" )
      output_50['construction_phase'] <- replace(output_50$phase_lookup_uid, output_50$phase_lookup_uid == 4, "Unknown" )
      output_50 <- output_50 %>% select(smp_id, construction_phase)
      
      kable(output_50, caption = "SMPs within 50 ft of new/changed WIC parcels ")
...
```{r section 9- displaying summary table of SMP association at buffer 100ft, include=FALSE, eval= nrow(output_100)>0}
      ...
      output_100['construction_phase'] <- replace(output_100$phase_lookup_uid, output_100$phase_lookup_uid == 2, "During-construction" )
      output_100['construction_phase'] <- replace(output_100$phase_lookup_uid, output_100$phase_lookup_uid == 3, "Post-construction" )
      output_100['construction_phase'] <- replace(output_100$phase_lookup_uid, output_100$phase_lookup_uid == 4, "Unknown" )
      output_100 <- output_100 %>% select(smp_id, construction_phase)
      
      kable(output_100, caption = "SMPs within 100 ft of new/changed WIC parcels ")
